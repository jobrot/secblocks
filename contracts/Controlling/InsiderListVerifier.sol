...
//TOKEN SPECIFIC Verifier that stores addresses in a blacklist, corresponds to a single token (one company normally)
...
contract InsiderListVerifier is IVerifier, InsiderListManagerRole {
    ...
    * @dev Forbids transfer if _from, _to, and _spender are on the blacklist
    * @return {
